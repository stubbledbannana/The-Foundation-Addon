package com.foundation.modules;
import meteordevelopment.meteorclient.utils.player.FindItemResult;
import com.foundation.FoundationAddon;
import com.foundation.mixin.accessor.PlayerInventoryAccessor;
import com.foundation.mixin.accessor.UpdateSelectedSlotS2CPacketAccessor;
...
import com.foundation.utils.RotationUtils;
import com.foundation.utils.PlacementUtils;
import com.foundation.utils.InventoryManager;
import com.foundation.utils.FoundationUtils;
...
public class Phase extends Module {
    ...
    public Phase() {
        super(FoundationAddon.CATEGORY, "phase", "Allows player to phase through solid blocks using ender pearls.");
    ...
    @EventHandler
    private void onPushOutOfBlocks(FoundationUtils event) {
        if (isActive()) {
            event.cancel();
        }
    }
