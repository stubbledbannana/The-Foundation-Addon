...
public class ArmorNotify extends Module {
    ...
    public ArmorNotify() {
        super(FoundationAddon.CATEGORY, "armor-notify", "Notifies you when your armor pieces are low.");
    }
    ...
    private void checkArmorPiece(ItemStack armor, String message, double thresholdValue, int slot) {
        boolean isLow = FoundationUtils.checkThreshold(armor, thresholdValue);
